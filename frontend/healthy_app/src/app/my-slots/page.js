					...
					<Container className="basis-7/12">
						...
						<div className="flex flex-col text-xs  w-full bg-gray-100 px-4 rounded-2xl py-4 dark:bg-trueGray-800 ">
							<div className="flex flex-row flex-wrap">
								<div>
									<button className="rounded-3xl bg-blue-950 text-white m-2 p-4 basis-1/4 text-lg">
										09:00-10:00
									</button>
								</div>
								<div>
									<button className="rounded-3xl bg-indigo-300 text-white m-2 p-4 basis-1/4 text-lg">
										10:00-11:00
									</button>
								</div>
								<div>
